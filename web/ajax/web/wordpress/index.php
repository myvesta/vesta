...
if ($is_wordpress_installed == '1') {
    ...
    echo myvesta_get_element('button_gray', '', 'wordpress_lock', __('Lock WordPress'), null, 'width: 200px;'.$add_style, 'add', $link_text, $link_url, $disabled);
    ...
    echo myvesta_get_element('button_gray', '', 'wordpress_unlock', __('Unlock WordPress'), null, 'width: 200px;'.$add_style, 'add', $link_text, $link_url, $disabled);
