...
echo myvesta_get_element('button_gray', '', 'wordpress_install', __('Install WordPress'), null, 'width: 250px;', 'add', '['.__("What's this?").']', 'https://forum.myvestacp.com/viewtopic.php?t=386');
...
if ($is_wordpress_installed == '1') {
    ...
    echo myvesta_get_element('button_gray', '', 'wordpress_lock', __('Lock WordPress'), null, 'width: 250px;'.$add_style, 'add', $link_text, $link_url, $disabled);
    ...
    echo myvesta_get_element('button_gray', '', 'wordpress_unlock', __('Unlock WordPress'), null, 'width: 250px;'.$add_style, 'add', $link_text, $link_url, $disabled);

    // Add admin user
    echo myvesta_get_element('button_gray', '', 'wordpress_add_admin_user', __('Add WordPress Admin User'), null, 'width: 250px;', 'add', '['.__("What's this?").']', 'https://forum.myvestacp.com/viewtopic.php?t=1130');

    // Clone
    echo myvesta_get_element('button_gray', '', 'wordpress_clone_step1', __('Clone WordPress'), null, 'width: 250px;', 'add', '['.__("What's this?").']', 'https://forum.myvestacp.com/viewtopic.php?t=385');
