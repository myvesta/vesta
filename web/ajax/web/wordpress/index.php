...
echo myvesta_get_element('button_gray', '', 'wordpress_install', __('Install WordPress'), null, 'width: 200px;', 'add', '['.__("What's this?").']', 'https://forum.myvestacp.com/viewtopic.php?t=386');
...
if ($is_wordpress_installed == '1') {
    ...
    if ($is_wordpress_locked == '0') echo myvesta_get_element('button_gray', '', 'wordpress_lock', __('Lock WordPress'), null, 'width: 200px;', 'add', '['.__("What's this?").']', 'https://forum.myvestacp.com/viewtopic.php?t=725');
    if ($is_wordpress_locked == '1') echo myvesta_get_element('button_gray', '', 'wordpress_unlock', __('Unlock WordPress'), null, 'width: 200px;', 'add', '['.__("What's this?").']', 'https://forum.myvestacp.com/viewtopic.php?t=725');

    // Clone
    echo myvesta_get_element('button_gray', '', 'wordpress_clone_step1', __('Clone WordPress'), null, 'width: 200px;', 'add', '['.__("What's this?").']', 'https://forum.myvestacp.com/viewtopic.php?t=385');
}
