...
echo myvesta_get_element('checkbox', 'On/Off', 'onoff', '1');
echo myvesta_get_element('button', '', 'button1', 'Hello World', null, 'width: 200px;', 'add');
echo myvesta_get_element('input', 'Variable 1 label:', 'var1', 'val1');
echo myvesta_get_element('textarea', 'Variable 2 label:', 'var2', 'val2'); 
echo myvesta_get_element('listbox', 'Variable 3 label:', 'var3', array('1' => 'Option 1', '2' => 'Option 2', '3' => 'Option 3'), '2');
